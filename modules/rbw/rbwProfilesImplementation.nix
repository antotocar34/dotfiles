{
  flake.modules.homeManager.cli =
    ...
    {
      options = {
        programs.rbwProfile = lib.mkOption {
          default = { };
          type = lib.types.lazyAttrsOf (lib.types.submodule rbwDefinitionModule);
          ...
          constructRbwWithProfile =
            ...
            [
              ...
              (lib.mkIf (cfg'.settings != null && !isDarwin) {
                xdg.configFile."rbw-${name}/config.json".source =
